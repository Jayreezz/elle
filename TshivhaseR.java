...
public class TshivhaseR extends JPanel{
    ...
    int highScore;  
    int speedOpponent[]; 
    boolean isFinished;     boolean isUp, isDown, isRight, isLeft; 
    ...
    public static void main(String args[]){
        ...
        TshivhaseR game = new TshivhaseR(); //creating a new instance of a Game
